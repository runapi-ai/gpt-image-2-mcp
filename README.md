...
<p align="center">
  <a href="https://www.npmjs.com/package/@runapi.ai/gpt-image-2-mcp"><img src="https://img.shields.io/npm/v/%40runapi.ai/gpt-image-2-mcp?style=flat-square&color=blue" alt="npm version"></a>
  <a href="https://github.com/runapi-ai/gpt-image-2-mcp"><img src="https://img.shields.io/badge/GitHub-runapi--ai%2Fgpt-image-2-mcp-24292f?style=flat-square" alt="GitHub repository"></a>
...
Use this per-model server when an agent should stay scoped to GPT Image 2. Use [`@runapi.ai/mcp`](https://github.com/runapi-ai/mcp) when one assistant should discover every RunAPI model line.
...
| Tool | Models |
|---|---|
| `edit_image` | `gpt-image-2` |
| `text_to_image` | `gpt-image-2` |

Model availability can change between releases. Use `check_pricing` or the [GPT Image 2 model page](https://runapi.ai/models/gpt-image-2) for the current catalog view.
...
The assistant calls `check_pricing` and can link to the [GPT Image 2 model page](https://runapi.ai/models/gpt-image-2) for the canonical catalog entry.
...
| Resource | URL |
|---|---|
| GPT Image 2 model page | [https://runapi.ai/models/gpt-image-2](https://runapi.ai/models/gpt-image-2) |
| npm package | [@runapi.ai/gpt-image-2-mcp](https://www.npmjs.com/package/@runapi.ai/gpt-image-2-mcp) |
| GitHub repository | [runapi-ai/gpt-image-2-mcp](https://github.com/runapi-ai/gpt-image-2-mcp) |
